 ...
 *       2.
 *   <li>The number of entries in this keystore, as a four-byte integer. Call this value <i>n</i>
 *   <li>Then, <i>n</i> times:
 *       <ol>
 ...
 * </ol>
 *
 * <p>(See <a href="http://metastatic.org/source/genkey.java">this file</a> for some idea of how I
 ...
 *
 * <p>The original source code by Casey Marshall of this class should be available in the file <a
 * href="http://metastatic.org/source/JKS.java">http://metastatic.org/source/JKS.java</a>.
 *
 * <p>Changes by Ken Ellinwood:
 *
 * <ul>
 *   <li>Fixed a NullPointerException in engineLoad(). This method must return gracefully if the
 *       keystore input stream is null.
 *   <li>engineGetCertificateEntry() was updated to return the first cert in the chain for private
 *       key entries.
 *   <li>Lowercase the alias names, otherwise keytool chokes on the file created by this code.
 *   <li>Fixed the integrity check in engineLoad(), previously the exception was never thrown
 ...
 */
class JavaKeyStoreSpi extends KeyStoreSpi {
