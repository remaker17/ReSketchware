...
public class ColorPickerUtil {
    ...
    private static final List<Integer> PURPLE = Arrays.asList(0xfff3e5f5, 0xffe1bee7, 0xffce93d8, 0xffba68c8, 0xffab47bc, 0xff9c27b0, 0xff8e24aa, 0xff7b1fa2, 0xff6a1b9a, 0xff4a148c);
